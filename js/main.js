...
/***/ "./src/js/components/middleIconActive.js":
/*!***********************************************!*\
  !*** ./src/js/components/middleIconActive.js ***!
  \***********************************************/
...
if (document.querySelector('.education__icons')) {
  document.querySelectorAll('.education__icons').forEach(function (element) {
    var arr = element.querySelectorAll('.education__icon');
...
if (document.querySelector('[data-social]')) {
  ...
  var title = document.querySelector('.main-banner__title').textContent;
  var description = document.querySelector('.main-banner__description').textContent;
  var image = document.querySelector('meta[property="og:image"]');
  var ignor = document.querySelector('.main-banner__top');
  html2canvas__WEBPACK_IMPORTED_MODULE_1___default()(document.querySelector('.main-banner'), {
    backgroundColor: "#F1F1F1"
  }).then(function (canvas) {
    document.body.appendChild(canvas);
    image.setAttribute('content', canvas.toDataURL());
  });
  Array.prototype.forEach.call(list, function (item) {
    item.addEventListener('click', function (e) {
      var social = e.currentTarget.dataset.social;
      var url = location.origin + location.pathname;
      ninelines_sharing__WEBPACK_IMPORTED_MODULE_0__["default"][social](url, null, title, description);
    });
  });
}
...
/* harmony import */ var _components_middleIconActive__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/middleIconActive */ "./src/js/components/middleIconActive.js");
/* harmony import */ var _components_middleIconActive__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_middleIconActive__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _modules_backToTop__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/backToTop */ "./src/js/modules/backToTop.js");
...
_modules_backToTop__WEBPACK_IMPORTED_MODULE_10__["default"].init();
...
var Progress = /*#__PURE__*/function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Progress, [{
    ...
    key: "getPercent",
    value: function getPercent(current, total) {
...
var init = function init() {
  var svgPerscent = new _modules_Progress__WEBPACK_IMPORTED_MODULE_1__["default"]('.to-top');
  ...
  _helpers__WEBPACK_IMPORTED_MODULE_0__["default"].$window.on('scroll.backTop', function () {
    ...
    var heightOfPage = _helpers__WEBPACK_IMPORTED_MODULE_0__["default"].$document.height() - window.innerHeight;
